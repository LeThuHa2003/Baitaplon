<?php 
    ...
    if (isset($_SESSION['Admin'])) { 
        ...
        //xóa 1 thành viên
        if (isset($_GET['del_idlh']))
        {
            $malh = $_GET['del_idlh'];
            $queryDelete = "DELETE FROM LienHe WHERE MaLH = '$malh'";
            mysqli_query($conn, $queryDelete) or die('query failed');
            mysqli_close($conn);
            header("Location: QLLH.php?deleted_malh=$malh");
        }
?>
...
<html>
    ...
    <body >
        ...
        <section class="qlsp" >
            ...
            <div class="search-field">
                <form action="" method="GET">
                    <input type="text" name="search" placeholder="Mã, Tên khách hàng...">
            ...
            <div class="container" style="overflow-x: auto;">
                <!-- <form action=""> -->
                    <table class="tbl_qlsp">
                        ...
                        {
                            $search = $_GET['search'];
                            $str1 = "SELECT * FROM LienHe WHERE MaLH like '%$search%' OR HoTenKH like '%$search%' OR SDT like '%$search%' OR Email like '%$search%' OR NoiDungCauHoi like '%$search%'"; 
                            ...
                            <tr class="items">
                                ...
                                <td class="mahoa" title="<?php echo $row['NoiDungCauHoi']; ?>"> <?php echo $row['NoiDungCauHoi']?> </td>
                                <td style="text-align: center;"> <?php echo $row['NgayLH']?></td>
                                <td style="text-align: center;"> <a href="QLLH.php?del_idlh=<?php echo $row['MaLH']?>" onclick="return confirm('Bạn có chắc chắn muốn xóa câu hỏi này không?');" class="fas fa-trash"></a></td>
                            </tr>
                                <?php }} else {
        ...
        <script>
            var deleted_malh = "<?php echo isset($_GET['deleted_malh']) ? $_GET['deleted_malh'] : ''; ?>";
            if (deleted_malh !== '') {
                alert("Bạn đã xóa thông tin liên hệ có mã " + deleted_malh);
            }
        </script>
