<?php 
    ...
    $str = "SELECT * FROM SanPham WHERE MaDanhMuc = 'CMCST'";
    ...
    //Caculate total page
    $str_count = "SELECT COUNT(*) AS count FROM SanPham WHERE MaDanhMuc = 'CMCST'";
...
<head>
    ...
    <title>Cỏ mềm Chăm sóc tóc</title>
...
<?php include "header.php"; ?>
    ...
    <section class="breadcrumb">
        <div class="first_container">
            ...
            <span style="margin: 0 1.5rem;"> / </span>
            <a href="CMCST.php">Cỏ mềm chăm sóc tóc</a>
        </div>
    </section>
    ...
    <section>
        <div class="container" style="display: flex;">
            ...
            <div class="second_container" style="display: grid;">
                <form action="CMCST.php" method="GET">
                    <div class="banner_TD">
                    <img src="images/CST_banner.webp" alt="" style="width: 100%;">
                    </div><br>
                    ...
                    <div><p style="font-size: 1.7rem; color: #3e6807; margin-bottom: 2rem; text-align: justify; line-height: 3rem; text-transform: none;">Mái tóc dày mượt, bồng bềnh 
                    và sạch gàu luôn là niềm tự hào của chị em phụ nữ. Nhưng hiện nay sử dụng dầu gội hóa chất khiến tóc ngày càng yếu, tóc rụng ngày càng nhiều khiến bạn cảm thấy 
                    thiếu tự tin. Để mùi hoa cỏ thiên nhiên phảng phất trên mái tóc, giúp tóc chắc khỏe và cải thiện bạn có thể bỏ ra chút thời gian tự làm các loại dầu gội thiên 
                    nhiên theo hướng dẫn dưới đây. Nồi nước gội đầu vừa ăn toàn không hóa chất và chứa nhiều tinh dầu từ thiên nhiên giúp mái tóc bóng khỏe, ngăn gãy rụng tóc một 
                    cách vô cùng hiệu quả.</p></div><br>
                </form>
