<?php 
    ...
    $str = "SELECT * FROM SanPham WHERE MaDanhMuc = 'CMCSD'";
    ...
    //Caculate total page
    $str_count = "SELECT COUNT(*) AS count FROM SanPham WHERE MaDanhMuc = 'CMCSD'";
...
<head>
    ...
    <title>Cỏ mềm Chăm sóc da</title>
    ...
    <section>
        <div class="container" style="display: flex;">
            ...
            <div class="second_container" style="display: grid;">
                <form action="CMCSD.php" method="GET">
                    <div class="banner_TD">
                    <img src="images/CSD_banner.webp" alt="" style="width: 100%;">
                    </div><br>
                    ...
                    <div><p style="font-size: 1.7rem; color: #3e6807; margin-bottom: 2rem; text-align: justify; line-height: 3rem; text-transform: none;">Chăm sóc da là nhu cầu cơ bản 
                    không chỉ của chị em phụ nữ mà của tất cả mọi người. Để có 1 làn da đẹp, bạn cần chăm sóc nó đều đặn hàng ngày. 
                    Vậy liệu bạn đã biết cách chăm sóc da đúng chưa? Hãy cùng tìm hiểu về các dòng sản phẩm chăm sóc da từ thiên nhiên của nhà Cỏ Mềm và 8 bước chăm 
                    sóc da cơ bản hằng ngày để có 1 làn da đẹp và khỏe mạnh nhé.</p></div><br>
                </form>
