<?php 
    ...
    $str = "SELECT * FROM SanPham WHERE MaDanhMuc = 'CMTD'";
    ...
    //Caculate total page
    $str_count = "SELECT COUNT(*) AS count FROM SanPham WHERE MaDanhMuc = 'CMTD'";
    ...
    <section>
        <div class="container" style="display: flex;">
            ...
            <div class="second_container" style="display: grid;">
                <form action="CMTD.php" method="GET">
                    <div class="banner_TD">
                        <img src="images/TD_banner.webp" alt="" style="width: 100%;">
                    </div><br>
                    ...
                    <div><p style="font-size: 1.7rem; color: #3e6807; margin-bottom: 2rem; text-align: justify; line-height: 3rem; text-transform: none;">Tẩy tế bào chết môi 
                    là bước quan trọng và cần thiết để có một đôi môi mềm mại, căng mọng, giúp màu son lên môi chuẩn hơn. Chăm sóc cho đôi môi bằng cách tẩy tế bào chết cho 
                    môi 1-2 lần/ tuần bằng sản phẩm Tẩy da chết Lipscrub Môi Hồng nhà Cỏ được các tín đồ làm đẹp tin dùng.</p></div><br>
                </form>
                <div class="products" id="products">
                    ...
                    if (mysqli_num_rows($result3) > 0)
                    {
                        foreach ($result3 as $row)
                        {
                            ...
                            $sale = ceil($gia_sale / 1000) * 1000;    //$sale = ceil(3001 / 1000) * 1000;
                            // ceil(3.001) * 1000 = 4 * 1000 = 4000
                            // $sale = 4000
                    ?>
                            <div class="box">
